...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='F:/Datasets_project/datasets/glasswall/glasswall_original/images')
    parser.add_argument('--source_xml_path', type=str, default='F:/Datasets_project/datasets/glasswall/glasswall_original/labels.xml')
    parser.add_argument('-save_img_path', type=str, default='F:/Datasets_project/datasets/aug_dataset/images')
    parser.add_argument('-save_xml_path', type=str, default='F:/Datasets_project/datasets/aug_dataset/labels_xml')
