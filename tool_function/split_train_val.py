...
# 原数据集目录
root_dir = 'F:\Datasets_project\datasets/roof/origin'
# 划分比例
train_ratio = 0.8
valid_ratio = 0.2
test_ratio = 0
...
# 拆分后数据集目录
split_dir = 'F:\Datasets_project\datasets/roof'
...
# 获取图片文件列表
image_files = os.listdir(os.path.join(root_dir, 'F:\Datasets_project\datasets/roof/origin/images'))
label_files = os.listdir(os.path.join(root_dir, 'F:\Datasets_project\datasets/roof/origin/labels'))
